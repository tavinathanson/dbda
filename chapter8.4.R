# Look at prior of difference of parameters

# A. Reproduce figure 8.7

# myData$y = c()

# B. change prior to beta(theta|1,1)

# theta[sIdx] ~ dbeta( 1 , 1 ) in "MbernBeta.R
# priors look flat and difference is triangular
