...
# verified that autocorrellation was lowest for SD=0.2,
# and correlation at lag=10 matches the ACF over lag plot

# C. for proposed SD=2, why does scatter plot have a dense line out points?
# because most proposals are rejected, leaving the move exactly where it was
# the last move